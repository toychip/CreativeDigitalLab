...
public enum WebSocketExceptionCode implements CdlExceptionCode {
    ...
    MESSAGE_ID_REQUIRED("WS-004-MESSAGE_ID_REQUIRED", "messageId 가 필요합니다."),
    UNKNOWN_MESSAGE_TYPE("WS-005-UNKNOWN_MESSAGE_TYPE", "알 수 없는 메시지 타입입니다."),
    UNAUTHORIZED("WS-006-UNAUTHORIZED", "인증이 필요합니다."),
    INTERNAL_SERVER_ERROR("WS-007-INTERNAL_SERVER_ERROR", "서버 내부 오류가 발생했습니다.");
